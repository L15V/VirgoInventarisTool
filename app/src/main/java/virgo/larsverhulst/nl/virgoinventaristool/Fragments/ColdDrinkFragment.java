...
public class ColdDrinkFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        colaButton = v.findViewById(R.id.cold_Drink_cola);
        colaZeroButton = v.findViewById(R.id.cold_drink_cola_zero);
        spriteButton = v.findViewById(R.id.cold_drink_sprite);
        fantaButton = v.findViewById(R.id.cold_drink_fanta);
        cassisButton = v.findViewById(R.id.cold_drink_cassis);
        redbullButon = v.findViewById(R.id.cold_drink_redbull);
        fuzeGreenButton = v.findViewById(R.id.cold_drink_fuze_green);
        fuzeSparklingButton = v.findViewById(R.id.cold_drink_fuze_sparkling);
        fuzeBlackteaButton = v.findViewById(R.id.cold_drink_fuze_blacktea);
        o2GeelButton = v.findViewById(R.id.cold_drink_o2Geel);
